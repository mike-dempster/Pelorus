# ContextFactory(*TContext*) Methods
 

The <a href="EC90D80">ContextFactory(TContext)</a> generic type exposes the following members.
...
<a href="#contextfactory(*tcontext*)-methods">Back to Top</a>
