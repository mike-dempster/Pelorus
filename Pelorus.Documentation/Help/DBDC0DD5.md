# DataRecordExtensions.GetNullableInt32 Method 
...
``` VB
<ExtensionAttribute>
Public Shared Function GetNullableInt32 ( 
...
public:
[ExtensionAttribute]
static Nullable<int> GetNullableInt32(
	IDataRecord^ reader, 
	String^ name
)
```
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/b3h38hb0" target="_blank">Nullable</a>(<a href="http://msdn2.microsoft.com/en-us/library/td2s409d" target="_blank">Int32</a>)<br />Int32 or null value of the specified column.
