# TypeExtensions.Method(*T0*, *T1*, *T2*) Method (Type, String)
...
**C#**<br />
``` C#
public static MethodInfo Method<T0, T1, T2>(
	this Type subject,
	string methodName
)
...
``` VB
<ExtensionAttribute>
Public Shared Function Method(Of T0, T1, T2) ( 
	subject As Type,
...
#### Type Parameters
&nbsp;<dl><dt>T0</dt><dd>Type of the first argument.</dd><dt>T1</dt><dd>Type of the second argument.</dd><dt>T2</dt><dd>Type of the third argument.</dd></dl>
