# DataRecordExtensions.GetChar Method 
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/k493b04s" target="_blank">Char</a><br />Char value of the specified column.
