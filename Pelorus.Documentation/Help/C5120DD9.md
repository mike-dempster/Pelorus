# DataRecordExtensions.GetNullableInt16 Method 
...
``` VB
<ExtensionAttribute>
Public Shared Function GetNullableInt16 ( 
...
public:
[ExtensionAttribute]
static Nullable<short> GetNullableInt16(
	IDataRecord^ reader, 
	String^ name
)
```
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/b3h38hb0" target="_blank">Nullable</a>(<a href="http://msdn2.microsoft.com/en-us/library/e07e6fds" target="_blank">Int16</a>)<br />Int16 or null value of the specified column.
