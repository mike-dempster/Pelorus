# TypeExtensions.Method(*T0*, *T1*) Method (Type, String)
...
**C#**<br />
``` C#
public static MethodInfo Method<T0, T1>(
	this Type subject,
	string methodName
)
...
``` VB
<ExtensionAttribute>
Public Shared Function Method(Of T0, T1) ( 
	subject As Type,
...
#### Type Parameters
&nbsp;<dl><dt>T0</dt><dd>Type of the first argument.</dd><dt>T1</dt><dd>Type of the second argument.</dd></dl>
