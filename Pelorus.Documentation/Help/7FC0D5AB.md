# DataRecordExtensions.GetNullableDateTime Method 
...
``` VB
<ExtensionAttribute>
Public Shared Function GetNullableDateTime ( 
...
public:
[ExtensionAttribute]
static Nullable<DateTime> GetNullableDateTime(
	IDataRecord^ reader, 
	String^ name
)
```
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/b3h38hb0" target="_blank">Nullable</a>(<a href="http://msdn2.microsoft.com/en-us/library/03ybds8y" target="_blank">DateTime</a>)<br />DateTime or null value of the specified column.
