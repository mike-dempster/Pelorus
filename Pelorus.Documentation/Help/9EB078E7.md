# DataRecordExtensions.GetDateTime Method 
...
``` VB
<ExtensionAttribute>
Public Shared Function GetDateTime ( 
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/03ybds8y" target="_blank">DateTime</a><br />DateTime value of the specified column.
