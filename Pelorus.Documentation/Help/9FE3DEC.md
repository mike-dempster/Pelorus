# XmlSchemaPropertyConfiguration(*T*, *TProperty*).IsText Method 
...
**VB**<br />
``` VB
Public Function IsText As XmlSchemaPropertyConfiguration(Of T, TProperty)
```

**C++**<br />
``` C++
public:
XmlSchemaPropertyConfiguration<T, TProperty>^ IsText()
```
