# DataRecordExtensions.GetNullableInt64 Method 
...
``` VB
<ExtensionAttribute>
Public Shared Function GetNullableInt64 ( 
...
public:
[ExtensionAttribute]
static Nullable<long long> GetNullableInt64(
	IDataRecord^ reader, 
	String^ name
)
```
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/b3h38hb0" target="_blank">Nullable</a>(<a href="http://msdn2.microsoft.com/en-us/library/6yy583ek" target="_blank">Int64</a>)<br />Int64 or null value of the specified column.
