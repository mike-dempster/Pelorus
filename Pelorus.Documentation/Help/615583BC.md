# DataRecordExtensions.GetNullableXml Method 
...
**C#**<br />
``` C#
public static XmlDocument GetNullableXml(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetNullableXml ( 
...
public:
[ExtensionAttribute]
static XmlDocument^ GetNullableXml(
	IDataRecord^ reader, 
	String^ name
)
```
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/6kza7w4k" target="_blank">XmlDocument</a><br />XML value of the specified column.
