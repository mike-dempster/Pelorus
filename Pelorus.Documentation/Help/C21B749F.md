# XmlSerializerContext.GetHashCode Method 
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/td2s409d" target="_blank">Int32</a><br />Hash code of the serializer context.
