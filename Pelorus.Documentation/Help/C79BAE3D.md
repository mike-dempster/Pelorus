# DistributedMutualExclusionConfigurationElement Class
...
**VB**<br />
``` VB
Public Class DistributedMutualExclusionConfigurationElement
	Inherits ConfigurationElement
```

**C++**<br />
``` C++
public ref class DistributedMutualExclusionConfigurationElement : public ConfigurationElement
```

The DistributedMutualExclusionConfigurationElement type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="FC2DD43E">DistributedMutualExclusionConfigurationElement</a></td><td>
Initializes a new instance of the DistributedMutualExclusionConfigurationElement class</td></tr></table>&nbsp;
<a href="#distributedmutualexclusionconfigurationelement-class">Back to Top</a>
