# DataRecordExtensions.GetBoolean Method 
...
``` VB
<ExtensionAttribute>
Public Shared Function GetBoolean ( 
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/a28wyd50" target="_blank">Boolean</a><br />Boolean value of the specified column.
