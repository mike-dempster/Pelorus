# DataRecordExtensions.GetDecimal Method 
...
``` VB
<ExtensionAttribute>
Public Shared Function GetDecimal ( 
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/1k2e8atx" target="_blank">Decimal</a><br />Decimal value of the specified column.
