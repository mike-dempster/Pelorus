# LocalizerIgnoreAttribute Class
...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/e8kc3626" target="_blank">System.Attribute</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Pelorus.Core.Localization.LocalizerIgnoreAttribute<br />
...
**VB**<br />
``` VB
Public Class LocalizerIgnoreAttribute
	Inherits Attribute
```

**C++**<br />
``` C++
public ref class LocalizerIgnoreAttribute : public Attribute
```

The LocalizerIgnoreAttribute type exposes the following members.
...
<a href="#localizerignoreattribute-class">Back to Top</a>
