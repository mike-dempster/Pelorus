# DataRecordExtensions.GetNullableDouble Method 
...
``` VB
<ExtensionAttribute>
Public Shared Function GetNullableDouble ( 
...
public:
[ExtensionAttribute]
static Nullable<double> GetNullableDouble(
	IDataRecord^ reader, 
	String^ name
)
```
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/b3h38hb0" target="_blank">Nullable</a>(<a href="http://msdn2.microsoft.com/en-us/library/643eft0t" target="_blank">Double</a>)<br />Double or null value of the specified column.
